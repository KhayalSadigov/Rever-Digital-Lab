...
function AddBlog() {
  ...
  function submitForm(e) {
    ...
    if (!title) setError("Title is required!");
      ...
      axios
        .post(`${Base_Url}/api/blogs`, newData, {
          headers: {
        ...
        .then((res) => {
          ...
          store.blogs.setFiltered([...store.services.filteredData, newData]);
          Swal.fire("Success", "Blog successfully added!", "success");
          handleReset();
          store.blogAdd.setData(false);
        })
        .catch((err) => {
          setLoader(false);
  ...
  return (
    <>
      <div
        ...
        style={store.blogAdd.data ? {} : { display: "none" }}
        className={styles.glass}
      ></div>

      <div
        style={store.blogAdd.data ? {} : { height: "0", padding: "0" }}
